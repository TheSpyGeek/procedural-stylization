...
#include "stylization_v1_initial.h"

//QString Stylization_v1_initialNode::SHADER_PATH = QString("/disc/research/ideasAndNotes/coding-tests/silhouette-stylization/gratin-nodes/coherentStyle01/");
QString Stylization_v1_initialNode::SHADER_PATH = QString("/home/misnel/procedural-stylization/gratin/nodes/proceduralStyle/stylization_v1_initial/");


Stylization_v1_initialNode::Stylization_v1_initialNode(PbGraph *parent,NodeHandle *handle)
  : NodeTexture2D(parent,handle),
    _pSplat(QString(SHADER_PATH+"stylization_v1_initial-splatting.vert"),
       QString(SHADER_PATH+"stylization_v1_initial-splatting.frag")),
    _pBlend(QString(SHADER_PATH+"stylization_v1_initial-blending.vert"),
       QString(SHADER_PATH+"stylization_v1_initial-blending.frag")),
    _w(new Stylization_v1_initialWidget(this)),
    _vaoSplat(NULL),
    _nbElements(0),
    _sw(1),
    _sh(1),
...
Stylization_v1_initialNode::~Stylization_v1_initialNode() {
  delete _vaoSplat;
  cleanOITData();
}


void Stylization_v1_initialNode::apply() {
...
void Stylization_v1_initialNode::initSprites() {
...
void Stylization_v1_initialNode::initOITData() {
  cleanOITData();
...
void Stylization_v1_initialNode::cleanOITData() {
...
void Stylization_v1_initialNode::initFBO() {
...
void Stylization_v1_initialNode::cleanFBO() {
