...
#include "stylization_v2.h"

//QString Stylization_v2Node::SHADER_PATH = QString("/disc/research/ideasAndNotes/coding-tests/silhouette-stylization/gratin-nodes/coherentStyle01/");
QString Stylization_v2Node::SHADER_PATH = QString("/home/misnel/procedural-stylization/gratin/nodes/proceduralStyle/stylization_v2/");


Stylization_v2Node::Stylization_v2Node(PbGraph *parent,NodeHandle *handle)
  : NodeTexture2D(parent,handle),
    _pSplat(QString(SHADER_PATH+"stylization_v2-splatting.vert"),
       QString(SHADER_PATH+"stylization_v2-splatting.frag")),
    _pBlend(QString(SHADER_PATH+"stylization_v2-blending.vert"),
       QString(SHADER_PATH+"stylization_v2-blending.frag")),
    _w(new Stylization_v2Widget(this)),
    _vaoSplat(NULL),
    _nbElements(0),
    _sw(1),
    _sh(1),
...
Stylization_v2Node::~Stylization_v2Node() {
  delete _vaoSplat;
  cleanOITData();
}


void Stylization_v2Node::apply() {
...
void Stylization_v2Node::initSprites() {
...
void Stylization_v2Node::initOITData() {
  cleanOITData();
...
void Stylization_v2Node::cleanOITData() {
...
void Stylization_v2Node::initFBO() {
...
void Stylization_v2Node::cleanFBO() {
