...
\begin{abstract}
    ...
    Avant tout développement, il me semble important de remercier toutes les personnes ayant contribué au bon déroulement de mon stage et qui ont rendu cette expérience riche, variée et unique. Je voudrais d'abord remercier mes tuteurs de stages, Joëlle Thollot et Romain Vergne pour leur patience, leurs explications, la disponibilité qu’ils m’ont accordé. Ils m'ont partagé leurs savoirs sur le rendu non-photréaliste, sur la gestion d'un projet de recherche et sur leurs savoirs techniques. Je voudrais aussi remercier toute l'équipe MAVERICK pour leur chaleureux accueil. Il fut un réel plaisir de travailler avec toutes ces formidables personnes et il fut plaisant et flatteur d’être considérée comme un membre de cette équipe.Je vaudrais remercier l'INRIA et le Laboratoire Jean Kuntzmann pour m'avoir procuré les ressources nécessaire pour mener à bien ce projet.
