...
The most common way to display texture on an object is to do it in object space (also called 3D space) this permit to anchor the texture to each vertex of the models.
